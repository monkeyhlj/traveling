    ...
    private Handler myHandler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 0x00001:
                    for(Admin i:list){
                        TextView t1 = new TextView(UpdateAdmin.this);
                        t1.setText(i.getUsername());
                        t1.setWidth(700);
                        li.addView(t1);
                        EditText t2 = new EditText(UpdateAdmin.this);
                ...
                case 0x00002:
                    // e1.setText(s11);
                    Intent intent=new Intent(UpdateAdmin.this,Adminmanage.class);
